import { s as script$f } from './index-jtFS_Qvq.mjs';
import { isTouchDevice, addStyle, relativePosition, getOuterWidth, absolutePosition, find, findSingle } from '@primeuix/utils/dom';
import { s as script$7$1, a as script$e, U as UniqueComponentId, C as ConnectedOverlayScrollHandler, O as OverlayEventBus } from './index-BxMozEdj.mjs';
import { s as script$1$b } from './index-BewzCk0X.mjs';
...
import { s as script$j, a as script$1$c } from './index-BjfqnR8d.mjs';
...
import { s as script$i } from './index-DcyyOm7X.mjs';
import { s as script$h } from './index-CI0zemKa.mjs';
import { s as script$g } from './index-W-Mshwtv.mjs';
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_Select = script$e;
  const _component_InputOtp = script$d;
  const _component_Toast = script$f;
  _push(`<!--[--><div class="flex w-full h-screen flex-col items-center justify-center p-6" data-v-4be895eb><img${ssrRenderAttr("src", _imports_0)} alt="Login" class="h-28 w-28" data-v-4be895eb><div class="" data-v-4be895eb><p class="text-gray-500 text-2xl mb-10 text-center" data-v-4be895eb> Enter your details below to sign up </p>`);
  if (!$data.otpSent) {
    _push(`<form class="w-full flex flex-col items-center" data-v-4be895eb><div class="flex space-x-4 mb-4" data-v-4be895eb>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="firstName" data-v-4be895eb${_scopeId}>First Name</label>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="lastName" data-v-4be895eb${_scopeId}>Last Name</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "text",
    ...
    _push(`</div><div class="flex flex-col space-y-4 mb-4 w-full" data-v-4be895eb>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      variant: "on",
      class: "w-full"
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="email" data-v-4be895eb${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="phoneNumber" data-v-4be895eb${_scopeId}>Mobile Phone</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "number",
    ...
    _push(`<div class="flex" data-v-4be895eb>`);
    ...
    _push(`</div><button type="submit" class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600 mt-12" data-v-4be895eb> Sign Up </button></form>`);
  } else {
    _push(`<div class="flex flex-col items-center text-center" data-v-4be895eb><h3 class="text-3xl font-medium mb-4" data-v-4be895eb>Verify OTP</h3><p class="text-gray-500 mb-6" data-v-4be895eb> Enter the OTP sent to your email address. <span class="font-weight-bold font-bold" data-v-4be895eb>${ssrInterpolate($data.form.email)}</span></p><div class="w-full flex justify-center mb-4" data-v-4be895eb>`);
    _push(ssrRenderComponent(_component_InputOtp, {
      length: 6,
      mask: "*",
      modelValue: $data.otp,
      "onUpdate:modelValue": ($event) => $data.otp = $event,
      class: "p-inputtex text-center p-3 w-3/4 md:w-1/2 lg:w-1/3",
      placeholder: "Enter OTP"
    }, null, _parent));
    _push(`</div><button class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600" data-v-4be895eb> Verify OTP </button></div>`);
  }
  _push(`<p class="text-sm mt-4 text-center" data-v-4be895eb> Already have an account? <span class="text-blue-500 cursor-pointer" data-v-4be895eb> Log in </span></p></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-4be895eb"]]);
var script$b = {
  name: "EyeIcon",
  "extends": script$j
};
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_InputOtp = script$d;
  const _component_Toast = script$f;
  _push(`<!--[--><div class="flex w-full h-screen flex-col items-center justify-center" data-v-9da00c19><img${ssrRenderAttr("src", _imports_0)} alt="Login" class="h-28 w-28" data-v-9da00c19>`);
  if (!$data.isVerified && !$data.forgotPassword) {
    _push(`<div data-v-9da00c19><p class="text-gray-500 text-2xl mb-10 text-center" data-v-9da00c19> Welcome to Secure Group </p><form class="w-full flex flex-col items-center" data-v-9da00c19><div class="flex flex-col gap-4 w-full" data-v-9da00c19>`);
    _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="email" data-v-9da00c19${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="password" data-v-9da00c19${_scopeId}>Password</label>`);
        } else {
          return [
    ...
    _push(`</div><div class="mt-4 flex justify-end w-full" data-v-9da00c19><p class="text-blue-500 text-sm cursor-pointer" data-v-9da00c19> Forgot password? </p></div><button type="submit" class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600 mt-4" data-v-9da00c19> Log In </button></form><p class="text-sm mt-4 text-center" data-v-9da00c19> Don&#39;t have an account? <span class="text-blue-500 cursor-pointer" data-v-9da00c19> Sign up </span></p></div>`);
  } else if ($data.forgotPassword) {
    _push(`<div data-v-9da00c19><h3 class="text-gray-500 flex justify-center text-2xl font-medium mb-4" data-v-9da00c19> Reset Password </h3><p class="text-gray-500 mb-6 text-center" data-v-9da00c19> Enter your email address to receive a password reset link. </p>`);
    _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(ssrRenderComponent(_component_InputText, {
          ...
          _push2(`<label for="resetEmail" data-v-9da00c19${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(`<button class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600 mt-4" data-v-9da00c19> Send Reset Link </button><p class="text-sm mt-4 text-center cursor-pointer text-blue-500" data-v-9da00c19> Back to login </p></div>`);
  } else {
    _push(`<div data-v-9da00c19>`);
    if (!$data.resetPassword) {
      _push(`<div data-v-9da00c19><h3 class="text-3xl font-medium mb-4" data-v-9da00c19>Verify OTP</h3><p class="text-gray-500 mb-6" data-v-9da00c19> Enter the OTP sent to your email address: <span class="font-bold" data-v-9da00c19>${ssrInterpolate($data.form.email)}</span></p><div class="w-full mb-4 flex justify-center items-center" data-v-9da00c19>`);
      _push(ssrRenderComponent(_component_InputOtp, {
        length: 6,
        mask: "*",
        modelValue: _ctx.otp,
      ...
      _push(`</div><button class="w-full text-white py-3 rounded bg-red-600" data-v-9da00c19> Verify OTP </button></div>`);
    } else {
      _push(`<div data-v-9da00c19><h3 class="text-3xl font-medium mb-4 text-center" data-v-9da00c19>Reset Password</h3><p class="text-gray-500 mb-6" data-v-9da00c19>Enter a new password for your account.</p>`);
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Password, {
            ...
            _push2(`<label for="resetPassword" data-v-9da00c19${_scopeId}>New Password</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                modelValue: $data.form.newPassword,
      ...
      _push(ssrRenderComponent(_component_FloatLabel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="confirmNewPassword" data-v-9da00c19${_scopeId}>Confirm Password</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                modelValue: $data.form.confirmNewPassword,
      ...
      if ($options.passwordMismatch) {
        _push(`<p class="text-red-500 text-sm mt-2" data-v-9da00c19> Passwords do not match. </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="w-full text-white py-3 mt-4 rounded bg-red-600"${ssrIncludeBooleanAttr($options.passwordMismatch) ? " disabled" : ""} data-v-9da00c19> Reset Password </button></div>`);
    }
    _push(`</div>`);
  }
  _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-9da00c19"]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_InputText = script$7$1;
  const _component_RadioButton = script$g;
  const _component_Button = script$h;
  const _component_Checkbox = script$i;
...
//# sourceMappingURL=index-Jn560z5s.mjs.map
