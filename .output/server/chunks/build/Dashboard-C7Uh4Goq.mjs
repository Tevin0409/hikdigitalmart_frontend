import { _ as _sfc_main$5 } from './Footer-Dh1_azIl.mjs';
import { s as script$3 } from './index-CI0zemKa.mjs';
...
import { F as FlashCard, _ as _sfc_main$4, a as _sfc_main$3, T as TopCard, b as Footer, c as _sfc_main$2, d as _imports_0 } from './empty-BR8CuLH9.mjs';
import { a as script$1$1 } from './index-BjfqnR8d.mjs';
import { B as BaseStyle, _ as _export_sfc, a as useNuxtApp, u as useUserStore, g as useToast, b as useProductStore } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto my-10 pa-10" }, _attrs))} data-v-088b8356>`);
  ...
  _push(`<section data-v-088b8356><div class="p-4 rounded-md" data-v-088b8356><div class="flex justify-between items-center mb-4 px-2" data-v-088b8356><h2 class="text-lg font-semibold" data-v-088b8356>Top selling items</h2></div><div class="flex overflow-x-auto gap-4 p-2" data-v-088b8356><!--[-->`);
  ssrRenderList($setup.randomizedProducts, (product, index) => {
    var _a;
    _push(`<div class="min-w-[200px] md:min-w-[220px] bg-white rounded-md shadow-md cursor-pointer p-2" data-v-088b8356><div class="relative" data-v-088b8356><img${ssrRenderAttr("src", (_a = product.images[0]) == null ? void 0 : _a.uploadUrl)}${ssrRenderAttr("alt", product.name)} class="w-full h-36 object-cover rounded-md p-2" data-v-088b8356></div> ${ssrInterpolate(product.product.name)} <h3 class="text-sm font-medium mt-2 truncate" data-v-088b8356>${ssrInterpolate(product.name)}</h3><p class="text-lg font-semibold text-gray-900" data-v-088b8356>${ssrInterpolate($setup.formatPrice(product.price))}</p><p class="text-gray-500 text-xs line-through" data-v-088b8356>${ssrInterpolate(product.oldPrice)}</p></div>`);
  });
  _push(`<!--]--></div></div></section><section class="flash-sales mt-5 mx-2 full-screen" style="${ssrRenderStyle({ "min-height": "900px" })}" data-v-088b8356><div class="flex justify-between items-center mb-4" data-v-088b8356><h2 class="text-xl font-bold" data-v-088b8356>Explore Our Products</h2><div class="flex space-x-2" data-v-088b8356><button class="bg-red-500 text-white px-4 py-2" data-v-088b8356>View All</button></div></div><div class="flex" data-v-088b8356>`);
  if ($setup.filter) {
    _push(ssrRenderComponent(_component_FilterCard, null, null, _parent));
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="w-full" data-v-088b8356>`);
  if ($setup.fetching && $setup.products.length < 1) {
    _push(`<div class="text-center mt-6" data-v-088b8356><div class="relative flex justify-center items-center" data-v-088b8356><div class="absolute animate-spin rounded-full h-32 w-32 border-t-4 border-b-4 border-purple-100" data-v-088b8356></div><img src="https://freelancerdxb.s3.eu-central-1.amazonaws.com/documents/image%20%285%29__5d197f13926ac20a20a6f301d00ce69b516f83eb.png" class="rounded-full h-24 w-24" data-v-088b8356></div></div>`);
  } else if ($setup.products.length == 0) {
    _push(`<div class="flex flex-col items-center justify-center text-center mt-12 text-gray-500" data-v-088b8356><img${ssrRenderAttr("src", _imports_0)} alt="No items found" class="h-56 w-56" data-v-088b8356><p class="pt-6" data-v-088b8356>No items found</p></div>`);
  } else {
    _push(`<div class="grid gap-3 grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 justify-center" data-v-088b8356><!--[-->`);
  ...
  if ($setup.products.length != 0) {
    _push(`<div class="flex justify-center py-8" data-v-088b8356>`);
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-088b8356"]]);

export { Dashboard as default };
//# sourceMappingURL=Dashboard-C7Uh4Goq.mjs.map
