...
import { s as script$5, a as script$2$2, b as script$3$1 } from './index-CHf7NZjU.mjs';
...
import { U as UniqueComponentId, C as ConnectedOverlayScrollHandler, O as OverlayEventBus, s as script$2$3, a as script$9 } from './index-BZ-8HqfV.mjs';
...
import { s as script$6 } from './index-CBz_SNTb.mjs';
import { isNotEmpty, resolve, resolveFieldData, isEmpty, equals, findLastIndex } from '@primeuix/utils/object';
import { b as script$a, s as script$1$4 } from './index-XLr1qd4A.mjs';
import { s as script$8 } from './index-DEuunsqE.mjs';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="w-full bg-red flex justify-center items-center py-4"><div class="flex items-center space-x-2">`);
      _push(ssrRenderComponent(_component_AutoComplete, {
        modelValue: searchTerm.value,
        "onUpdate:modelValue": ($event) => searchTerm.value = $event,
        onInput: fetchProducts,
...
//# sourceMappingURL=Navbar-DMIrNmbv.mjs.map
