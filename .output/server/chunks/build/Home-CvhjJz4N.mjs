...
import { s as script$7$2, a as script$y, O as OverlayEventBus, g as getVNodeProp, U as UniqueComponentId, _ as _default, C as ConnectedOverlayScrollHandler, b as script$2$5 } from './index-BXa5O8IC.mjs';
...
import { s as script$G } from './index-DWifVPgv.mjs';
...
import { s as script$z } from './index-Cr6bhV-f.mjs';
import { s as script$A } from './index-DGRyAuRA.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($setup.categories.length) {
    _push(`<ul class="space-y-2 p-4"><!--[-->`);
    ssrRenderList($setup.categories, (item) => {
      _push(`<li class="flex items-center gap-2 pt-1 hover:text-primary hover:underline cursor-pointer font-regular"><i class="${ssrRenderClass($setup.getIcon(item.name))}"></i><span class="text-xs truncate">${ssrInterpolate(item.name)}</span></li>`);
    });
    _push(`<!--]--></ul>`);
  } else {
    _push(`<!---->`);
...
const CardsHome = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]);
...
const _sfc_main = {
  name: "ProductSection",
  components: { CardsHome, TopDeal, NewArrivals, Footer: __nuxt_component_0 },
  layout: "login",
  data() {
    return {
      price: "Ksh 2,400.00",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    ...
    style: { "background-image": "url('https://media.istockphoto.com/id/1255070620/photo/modern-house-with-garden-and-solar-panels.jpg?s=2048x2048&w=is&k=20&c=o-q6PLV-jwspJrtYwC-98d6bsBMW139OLXppJiglVcU=')" }
  }, _attrs))} data-v-a4c88c07><div class="flex flex-wrap justify-center items-start" data-v-a4c88c07><div class="product-details w-full md:w-1/3 mb-6 md:mb-0" data-v-a4c88c07><div class="badge text-primary text-sm font-semibold mb-2" data-v-a4c88c07> 100% Best Product </div><h1 class="text-3xl md:text-4xl font-bold mb-4" data-v-a4c88c07>HD Bullet Camera</h1><p class="text-gray-500 text-base md:text-lg mb-6" data-v-a4c88c07>Wide Angle</p><div class="price flex items-center text-xl md:text-2xl font-semibold text-red-600 mb-4" data-v-a4c88c07>${ssrInterpolate($data.price)} <span class="line-through text-gray-400 text-lg ml-4" data-v-a4c88c07>Ksh 2,860</span></div><div class="stock flex items-center text-sm text-gray-600 mb-6" data-v-a4c88c07><div class="w-full max-w-xs" data-v-a4c88c07><div class="relative" data-v-a4c88c07><div class="h-2 bg-gray-300 rounded" data-v-a4c88c07><div class="h-2 bg-primary rounded w-2/3" data-v-a4c88c07></div></div></div><div class="flex justify-between text-xs mt-2" data-v-a4c88c07><span data-v-a4c88c07>Available: 334</span><span data-v-a4c88c07>Stock: 180</span></div></div></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="px-6 py-3 bg-primary text-white rounded-lg shadow-lg hover:bg-secondary" data-v-a4c88c07${_scopeId}> SHOP NOW <i class="pi pi-angle-right" data-v-a4c88c07${_scopeId}></i></button>`);
      } else {
        return [
  ...
  _push(`</div><div class="dynamic-image flex justify-center items-center w-full md:w-1/3 mb-6 md:mb-0" data-v-a4c88c07><img${ssrRenderAttr("src", $data.selectedImage)} alt="Selected Product" class="w-full max-w-xs rounded-md border-0" data-v-a4c88c07></div><div class="hidden md:block w-full md:w-1/3 pa-6 ma-5 pl-40 dark:border-orange-600" data-v-a4c88c07><div class="border border-red-600 dark:border-orange-600 rounded p-4" data-v-a4c88c07><div class="mb-4 border-b pb-2 font-medium text-dark-600 text-center" data-v-a4c88c07> Top Product </div>`);
  _push(ssrRenderComponent(_component_Carousel, {
    d_circular: true,
    autoplayInterval: 3e3,
    value: $data.products,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        _push2(`<div class="text-center" data-v-a4c88c07${_scopeId}><img${ssrRenderAttr("src", (_a = slotProps.data) == null ? void 0 : _a.image)}${ssrRenderAttr("alt", (_b = slotProps.data) == null ? void 0 : _b.name)} class="object-cover rounded max-w-full mx-auto" data-v-a4c88c07${_scopeId}><div class="mt-4 font-medium" data-v-a4c88c07${_scopeId}>${ssrInterpolate((_c = slotProps.data) == null ? void 0 : _c.name)}</div><div class="font-semibold text-xl py-2" data-v-a4c88c07${_scopeId}>${ssrInterpolate(slotProps.data.price)}</div><div class="stock flex items-center text-sm text-gray-600 mb-4" data-v-a4c88c07${_scopeId}></div></div>`);
      } else {
        return [
  ...
  _push(`</div></div></div><div class="carousel flex justify-center items-center mt-8 space-x-4" data-v-a4c88c07><button class="text-gray-600 hover:text-gray-800 px-3 py-2 bg-gray-100 rounded-full shadow-md" data-v-a4c88c07> \u2190 </button><div class="flex items-center space-x-2 overflow-x-auto" data-v-a4c88c07><!--[-->`);
  ssrRenderList($data.images, (image, index) => {
    _push(`<img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", "Product " + (index + 1))} class="${ssrRenderClass([{ "border-orange-500": $data.selectedImage === image }, "w-12 h-12 md:w-16 md:h-16 rounded-md border border-gray-300 cursor-pointer hover:border-orange-500"])}" data-v-a4c88c07>`);
  });
  _push(`<!--]--></div><button class="text-gray-600 hover:text-gray-800 px-3 py-2 bg-gray-100 rounded-full shadow-md" data-v-a4c88c07> \u2192 </button></div><div class="feature__wrap grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 mt-12" data-v-a4c88c07><!--[-->`);
  ssrRenderList($data.features, (feature, index) => {
    _push(`<div class="feature__item flex flex-col items-center text-center" data-v-a4c88c07><div class="icon text-4xl text-red-500" data-v-a4c88c07><i class="${ssrRenderClass(feature.icon)}" data-v-a4c88c07></i></div><div class="content mt-2" data-v-a4c88c07><h3 class="text-lg font-semibold" data-v-a4c88c07>${ssrInterpolate(feature.title)}</h3><p class="text-sm text-gray-600" data-v-a4c88c07>${ssrInterpolate(feature.description)}</p></div></div>`);
  });
  _push(`<!--]--></div>`);
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a4c88c07"]]);

export { Dashboard as default };
//# sourceMappingURL=Home-CvhjJz4N.mjs.map
