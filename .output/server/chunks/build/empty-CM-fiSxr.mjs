...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><p class="ml-2 text-gray-500 text-sm text-center"> (${ssrInterpolate(__props.item.reviews)} reviews) </p></div></span></div><p class="text-red-500 font-semibold text-center"> Ksh ${ssrInterpolate(formattedPrice(__props.item.price))}</p></div><div class="absolute top-4 right-4 flex flex-col space-y-2 opacity-0group-hover:opacity-100 transition-opacity"><button class="p-2 rounded-full"><i class="pi pi-shopping-cart text-gray-600" style="${ssrRenderStyle({ "font-size": "1.2rem" })}"></i></button><button${ssrRenderAttr("loading", _ctx.loadingWish)}>`);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex gap-6 p-4" }, _attrs))} data-v-a2a38b9d><div class="w-1/5 bg-white shadow p-4 rounded-lg relative h-32 sm:h-40 md:h-80 xl:h-80 hidden lg:block" data-v-a2a38b9d>`);
      if (__props.categories.length) {
        _push(`<ul class="space-y-2" data-v-a2a38b9d><!--[-->`);
        ssrRenderList(__props.categories, (item) => {
          _push(`<li class="flex items-center gap-2 pt-3 hover:text-primary cursor-pointer font-regular" data-v-a2a38b9d><i class="${ssrRenderClass(getIcon(item.name))}" data-v-a2a38b9d></i><span class="text-xs truncate" data-v-a2a38b9d>${ssrInterpolate(item.name)}</span></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<p class="text-gray-50 text-xs text-center pt-3" data-v-a2a38b9d><!--[-->`);
        ssrRenderList(9, (i) => {
          _push(ssrRenderComponent(_component_Skeleton, { class: "mb-2 p-3" }, null, _parent));
        });
        _push(`<!--]--></p>`);
      }
      _push(`</div><div class="flex-1 bg-white shadow rounded-lg relative w-full h-32 sm:h-40 md:h-80 xl:h-80" data-v-a2a38b9d><div class="flex items-center gap-6 relative" data-v-a2a38b9d>`);
      if (unref(hoveredCategory)) {
        _push(`<div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-white text-2xl font-bold transition-opacity duration-300 rounded w-full h-32 sm:h-40 md:h-80 xl:h-80 p-4" data-v-a2a38b9d><div class="flex items-center mb-4" data-v-a2a38b9d><i class="${ssrRenderClass(getIcon(unref(hoveredCategory)))}" data-v-a2a38b9d></i><span class="ml-3" data-v-a2a38b9d>${ssrInterpolate(unref(hoveredCategory))}</span><ul class="space-y-2 text-lg text-center" data-v-a2a38b9d><!--[-->`);
        ssrRenderList(unref(products), (product) => {
          _push(`<li class="hover:underlinetransition" data-v-a2a38b9d>${ssrInterpolate(product.name)}</li>`);
        });
        _push(`<!--]--></ul></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (!unref(hoveredCategory)) {
        _push(ssrRenderComponent(_component_Carousel, {
          ...
          item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-lg object-cover w-full h-32 sm:h-40 md:h-80 xl:h-80" data-v-a2a38b9d${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
...
const TopCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a2a38b9d"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=empty-CM-fiSxr.mjs.map
