...
import { a as script$6, U as UniqueComponentId, C as ConnectedOverlayScrollHandler, O as OverlayEventBus, s as script$7$1, b as script$2$4 } from './index-BxMozEdj.mjs';
...
import { a as script$8, s as script$1$5 } from './index-BewzCk0X.mjs';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
      ...
      if (!selectedCategory.value || !selectedCategory.value.id) {
        ...
        router.push({
          ...
          query: {
            ...
            // Pass only the search term (trimmed, default to empty string)
          }
        });
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="w-full bg-red flex justify-center items-center py-4">`);
...
//# sourceMappingURL=Navbar-S4Njpvd7.mjs.map
