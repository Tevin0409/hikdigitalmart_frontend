...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "flex w-full align-center justify-center",
    style: { "background-image": "url('https://www.sdl.co.ke/assets/images/icons/vector-1.png')" }
  }, _attrs))} data-v-be47d37d><div class="flex w-full flex-col items-center justify-center" data-v-be47d37d><div class="flex justify-center items-center absolute top-16 left-8" data-v-be47d37d><a class="text-primary text-md cursor-pointer hover:text-secondary" data-v-be47d37d><i class="pi pi-arrow-left text-primary pr-2 hover:text-secondary" style="${ssrRenderStyle({})}" data-v-be47d37d></i> Back to Signup</a></div><div class="border shadow-xl mt-36 p-6 lg:ml-16 rounded-xl bg-white" data-v-be47d37d>`);
  _push(ssrRenderComponent(_component_Stepper, {
    value: $data.activeStep,
    "onUpdate:value": ($event) => $data.activeStep = $event,
    class: ""
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row flex-auto gap-2" }, a11yAttrs3.root))} data-v-be47d37d${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-be47d37d${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-be47d37d${_scopeId3}><i class="pi pi-building" data-v-be47d37d${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row flex-auto gap-2 pl-2" }, a11yAttrs3.root))} data-v-be47d37d${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-be47d37d${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-be47d37d${_scopeId3}><i class="pi pi-cog" data-v-be47d37d${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row pl-2" }, a11yAttrs3.root))} data-v-be47d37d${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-be47d37d${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-be47d37d${_scopeId3}><i class="pi pi-question-circle" data-v-be47d37d${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    ])}" data-v-be47d37d${_scopeId3}><i class="pi pi-check-circle" data-v-be47d37d${_scopeId3}></i></span></button></div>`);
                  } else {
                    return [
                      createVNode("div", mergeProps({ class: "flex flex-row pl-2" }, a11yAttrs3.root), [
                        createVNode("button", mergeProps({
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_StepPanel, { value: 1 }, {
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4 mx-auto" style="${ssrRenderStyle({ "min-width": "40vw" })}" data-v-be47d37d${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-be47d37d${_scopeId3}> Section 1: Personal Information </div><div class="flex gap-4" data-v-be47d37d${_scopeId3}><div class="field w-full" data-v-be47d37d${_scopeId3}><label for="firstName" class="font-bold" data-v-be47d37d${_scopeId3}>Company Name ( Full company name )</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.companyName) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.companyName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-be47d37d${_scopeId3}><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="firstName" class="font-bold" data-v-be47d37d${_scopeId3}>First Name</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.firstName) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.firstName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="wholesalerPersonalInfo.lastName" class="font-bold" data-v-be47d37d${_scopeId3}>Last Name</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.lastName) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.lastName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-be47d37d${_scopeId3}><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="wholesalerPersonalInfo.email" class="font-bold" data-v-be47d37d${_scopeId3}>Email Address</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.email) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.email)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="wholesalerPersonalInfo.email2" class="font-bold" data-v-be47d37d${_scopeId3}>Email Address 2</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.email2) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.email2)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-be47d37d${_scopeId3}><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="wholesalerPersonalInfo.phoneNumber" class="font-bold" data-v-be47d37d${_scopeId3}>Phone Number 1</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.phoneNumber) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.phoneNumber)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="wholesalerPersonalInfo.phoneNumber2" class="font-bold" data-v-be47d37d${_scopeId3}>Phone Number 2</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.phoneNumber2) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.phoneNumber2)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-be47d37d${_scopeId3}><div class="field w-1/2" data-v-be47d37d${_scopeId3}><label for="wholesalerPersonalInfo.address" class="font-bold" data-v-be47d37d${_scopeId3}>Business Address</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                    ...
                    if ($data.errors.wholesalerPersonalInfo.address) {
                      _push4(`<small class="text-red-500" data-v-be47d37d${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.address)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div></div><div class="flex pt-6 justify-end" style="${ssrRenderStyle({ "max-width": "800px", "margin": "0 auto" })}" data-v-be47d37d${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Next",
                      icon: "pi pi-arrow-right",
                      iconPos: "right",
              ...
              _push3(ssrRenderComponent(_component_StepPanel, {
                ...
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4" data-v-be47d37d${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-be47d37d${_scopeId3}> Section 2: Business Details </div><div data-v-be47d37d${_scopeId3}><label class="font-bold py-5" data-v-be47d37d${_scopeId3}> Which of the following describes your business well? </label> ${ssrInterpolate($data.wholesalerBusinessInfo.selectedBusinessType)} <!--[-->`);
                    ssrRenderList($data.businessTypes, (type) => {
                      _push4(`<div class="flex items-center gap-2" data-v-be47d37d${_scopeId3}>`);
                      _push4(ssrRenderComponent(_component_RadioButton, {
                      ...
                      _push4(`<label${ssrRenderAttr("for", type.key)} data-v-be47d37d${_scopeId3}>${ssrInterpolate(type.name)}</label></div>`);
                    });
                    _push4(`<!--]-->`);
                    ...
                    _push4(`</div><div data-v-be47d37d${_scopeId3}><label class="font-bold pb-3" data-v-be47d37d${_scopeId3}> Which brands do you deal with? </label><!--[-->`);
                    ssrRenderList($data.brandList, (brand) => {
                      ...
                      _push4(`<label${ssrRenderAttr("for", brand.key)} data-v-be47d37d${_scopeId3}>${ssrInterpolate(brand.name)}</label></div>`);
                    });
                    _push4(`<!--]-->`);
                    ...
                    _push4(`</div><div data-v-be47d37d${_scopeId3}><label class="font-bold pb-3" data-v-be47d37d${_scopeId3}> Which security brand do you have strength in? </label><!--[-->`);
                    ...
                    _push4(`<!--]--></div></div><div class="flex pt-6 justify-between" data-v-be47d37d${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
                      icon: "pi pi-arrow-left",
              ...
              _push3(ssrRenderComponent(_component_StepPanel, {
                ...
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4" data-v-be47d37d${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-be47d37d${_scopeId3}> Section 3: Technical Questions </div><div data-v-be47d37d${_scopeId3}><label class="font-bold pb-3" data-v-be47d37d${_scopeId3}> Which product categories do you mostly deal with? </label><!--[-->`);
                    ssrRenderList($data.productCategories, (category) => {
                      ...
                      _push4(`<label${ssrRenderAttr("for", category.key)} data-v-be47d37d${_scopeId3}>${ssrInterpolate(category.name)}</label></div>`);
                    });
                    _push4(`<!--]--></div><div data-v-be47d37d${_scopeId3}><label class="font-bold pb-3" data-v-be47d37d${_scopeId3}>What are the challenges you have faced when dealing with Hikvision?</label>`);
                    ...
                    _push4(`</div><div data-v-be47d37d${_scopeId3}><label class="font-bold pb-3" data-v-be47d37d${_scopeId3}>What would be your advice to Secure Digital Limited?</label>`);
                    _push4(ssrRenderComponent(_component_Textarea, {
              ...
              _push3(ssrRenderComponent(_component_StepPanel, { value: 4 }, {
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4 mx-auto w-full max-w-lg min-h-[20rem]" data-v-be47d37d${_scopeId3}><div class="text-center mt-4 mb-4 text-sm font-semibold" data-v-be47d37d${_scopeId3}><div class="p-6 rounded-lg shadow-md" data-v-be47d37d${_scopeId3}> Thank You! <p class="text-gray-700" data-v-be47d37d${_scopeId3}> Your application will undergo a thorough review. Upon successful verification, you will gain access to: </p><ul class="list-disc text-left pl-5 text-gray-700 mt-3" data-v-be47d37d${_scopeId3}><li data-v-be47d37d${_scopeId3}><strong data-v-be47d37d${_scopeId3}>Reseller Pricing</strong></li><li data-v-be47d37d${_scopeId3}><strong data-v-be47d37d${_scopeId3}>Comprehensive Marketing and Technical Resources</strong></li><li data-v-be47d37d${_scopeId3}><strong data-v-be47d37d${_scopeId3}>Product and Business Support</strong></li></ul><p class="text-gray-700 mt-4" data-v-be47d37d${_scopeId3}> For any inquiries or further assistance, please do not hesitate to contact us: </p><div class="bg-white p-4 rounded-lg shadow mt-4" data-v-be47d37d${_scopeId3}><p class="text-gray-800 font-semibold" data-v-be47d37d${_scopeId3}> \u{1F4E7} Email: <a href="mailto:sdl@hikvisionkenya.com" class="text-blue-600 hover:underline" data-v-be47d37d${_scopeId3}>sdl@hikvisionkenya.com</a></p><p class="text-gray-800 font-semibold" data-v-be47d37d${_scopeId3}> \u{1F4DE} Phone: <a href="tel:+254727909060" class="text-blue-600 hover:underline" data-v-be47d37d${_scopeId3}>+254 727 909 060</a></p></div><p class="text-gray-700 mt-6" data-v-be47d37d${_scopeId3}> We look forward to the opportunity to collaborate with you. </p><hr class="my-4 border-gray-300" data-v-be47d37d${_scopeId3}><p class="text-gray-800 font-bold" data-v-be47d37d${_scopeId3}>Best regards,</p><p class="text-gray-700" data-v-be47d37d${_scopeId3}> Secure Digital Limited | Hik Digital Mart Limited </p><p class="text-gray-700 font-semibold" data-v-be47d37d${_scopeId3}> SDLKenya Online Shop Administration Department </p><div class="bg-white p-4 rounded-lg shadow mt-4" data-v-be47d37d${_scopeId3}><p class="text-gray-800 font-semibold" data-v-be47d37d${_scopeId3}> \u{1F4E7} Email: <a href="mailto:sdl@hikvisionkenya.com" class="text-blue-600 hover:underline" data-v-be47d37d${_scopeId3}>sdl@hikvisionkenya.com</a></p><p class="text-gray-800 font-semibold" data-v-be47d37d${_scopeId3}> \u{1F4DE} Phone: <a href="tel:+254727909060" class="text-blue-600 hover:underline" data-v-be47d37d${_scopeId3}>+254 727 909 060</a></p></div></div></div></div><div class="flex pt-6 justify-between" data-v-be47d37d${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
                      icon: "pi pi-arrow-left",
  ...
  _push(`</div></div><div class="hidden md:block h-full w-full" data-v-be47d37d>`);
  _push(ssrRenderComponent(_component_Carousel, {
    verticalViewPortHeight: 2e3,
    autoplayInterval: 4e3,
    value: $data.images,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="relative w-full h-screen flex justify-center items-center" data-v-be47d37d${_scopeId}><img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-xl object-cover w-100 h-100" data-v-be47d37d${_scopeId}><div class="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white py-2 px-4 rounded" data-v-be47d37d${_scopeId}>${ssrInterpolate(slotProps.data.alt)}</div></div>`);
      } else {
        return [
          createVNode("div", { class: "relative w-full h-screen flex justify-center items-center" }, [
            createVNode("img", {
...
const WholesalerForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-be47d37d"]]);
...
//# sourceMappingURL=index-CNLgUmvo.mjs.map
