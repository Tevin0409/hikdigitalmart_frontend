...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="flex w-full h-screen flex-col items-center justify-center p-6" data-v-fa300555><img${ssrRenderAttr("src", _imports_0)} alt="Login" class="h-28 w-28" data-v-fa300555><div class="" data-v-fa300555><p class="text-gray-500 text-2xl mb-10 text-center" data-v-fa300555> Enter your details below to sign up </p>`);
  if (!$data.otpSent) {
    _push(`<form class="w-full flex flex-col items-center" data-v-fa300555><div class="flex space-x-4 mb-4" data-v-fa300555>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="firstName" data-v-fa300555${_scopeId}>First Name</label>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="lastName" data-v-fa300555${_scopeId}>Last Name</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "text",
    ...
    _push(`</div><div class="flex flex-col space-y-4 mb-4 w-full" data-v-fa300555>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      variant: "on",
      class: "w-full"
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="email" data-v-fa300555${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="phoneNumber" data-v-fa300555${_scopeId}>Mobile Phone</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "number",
    ...
    _push(`<div class="flex" data-v-fa300555>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      variant: "on",
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="password" data-v-fa300555${_scopeId}>Password</label>`);
        } else {
          return [
    ...
    _push(`</div><button type="submit" class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600 mt-12" data-v-fa300555> Sign Up </button></form>`);
  } else {
    _push(`<div data-v-fa300555><h3 class="text-3xl font-medium mb-4" data-v-fa300555>Verify OTP</h3><p class="text-gray-500 mb-6" data-v-fa300555> Enter the OTP sent to your email address. <span class="font-weight-bold" style="${ssrRenderStyle({ "font-weight": "bold" })}" data-v-fa300555>${ssrInterpolate($data.form.email)}</span></p><div class="w-full mb-4" data-v-fa300555>`);
    ...
    _push(`</div><button class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600" data-v-fa300555> Verify OTP </button></div>`);
  }
  _push(`<p class="text-sm mt-4 text-center" data-v-fa300555> Already have an account? <span class="text-blue-500 cursor-pointer" data-v-fa300555> Log in </span></p></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-fa300555"]]);
const _sfc_main$2 = {
  data() {
    return {
      form: {
...
//# sourceMappingURL=index-CiQykfNQ.mjs.map
