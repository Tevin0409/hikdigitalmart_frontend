...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_Carousel = script$f;
  const _component_Toast = script$g;
  _push(`<!--[--><div class="flex w-full align-center justify-center" style="${ssrRenderStyle({ "background-image": "url('https://www.sdl.co.ke/assets/images/icons/vector-1.png')" })}" data-v-38bcf261><div class="flex w-full h-screen flex-col items-center justify-center" data-v-38bcf261><div class="flex justify-center items-center absolute top-16 left-8" data-v-38bcf261><a href="/dashboard" class="text-primary text-md cursor-pointer hover:text-secondary" data-v-38bcf261><i class="pi pi-arrow-left text-primary pr-2 hover:text-secondary" style="${ssrRenderStyle({})}" data-v-38bcf261></i> Back to Shop</a></div><div class="border shadow-xl p-36 rounded-xl bg-white flex flex-col items-center" data-v-38bcf261><img${ssrRenderAttr("src", _imports_0)} alt="Login" class="h-28 w-28" data-v-38bcf261>`);
  if (!$data.isVerified && !$data.forgotPassword) {
    _push(`<div data-v-38bcf261><p class="text-gray-500 text-2xl mb-10 text-center" data-v-38bcf261> Welcome to Secure Group </p><form class="w-full flex flex-col items-center" data-v-38bcf261><div class="flex flex-col gap-4 w-full" data-v-38bcf261>`);
    _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="email" data-v-38bcf261${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="password" data-v-38bcf261${_scopeId}>Password</label>`);
        } else {
          return [
    ...
    _push(`</div><div class="mt-4 flex justify-end w-full" data-v-38bcf261><p class="text-blue-500 text-sm cursor-pointer" data-v-38bcf261> Forgot password? </p></div>`);
    ...
    _push(`</form><p class="text-sm mt-4 text-center" data-v-38bcf261> Don&#39;t have an account? <span class="text-blue-500 cursor-pointer" data-v-38bcf261> Sign up </span></p></div>`);
  } else if ($data.forgotPassword) {
    _push(`<div data-v-38bcf261><h3 class="text-gray-500 flex justify-center text-2xl font-medium mb-4" data-v-38bcf261> Reset Password </h3><p class="text-gray-500 mb-6 text-center" data-v-38bcf261> Enter your email address to receive a password reset link. </p>`);
    _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(ssrRenderComponent(_component_InputText, {
          ...
          _push2(`<label for="resetEmail" data-v-38bcf261${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(`<button class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600 mt-4" data-v-38bcf261> Send Reset Link </button><p class="text-sm mt-4 text-center cursor-pointer text-blue-500" data-v-38bcf261> Back to login </p></div>`);
  } else {
    _push(`<div data-v-38bcf261>`);
    if (!$data.resetPassword) {
      _push(`<div data-v-38bcf261><h3 class="text-3xl font-medium mb-4" data-v-38bcf261>Verify OTP</h3><p class="text-gray-500 mb-6" data-v-38bcf261> Enter the OTP sent to your email address: <span class="font-bold" data-v-38bcf261>${ssrInterpolate($data.form.email)}</span></p><div class="w-full mb-4 flex justify-center items-center" data-v-38bcf261>`);
      _push(ssrRenderComponent(_component_InputOtp, {
        length: 6,
        mask: "*",
        modelValue: _ctx.otp,
      ...
      _push(`</div><button class="w-full text-white py-3 rounded bg-red-600" data-v-38bcf261> Verify OTP </button></div>`);
    } else {
      _push(`<div data-v-38bcf261><h3 class="text-3xl font-medium mb-4 text-center" data-v-38bcf261> Reset Password </h3><p class="text-gray-500 mb-6" data-v-38bcf261> Enter a new password for your account. </p>`);
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Password, {
            ...
            _push2(`<label for="resetPassword" data-v-38bcf261${_scopeId}>New Password</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                modelValue: $data.form.newPassword,
      ...
      _push(ssrRenderComponent(_component_FloatLabel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="confirmNewPassword" data-v-38bcf261${_scopeId}>Confirm Password</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                modelValue: $data.form.confirmNewPassword,
      ...
      if ($options.passwordMismatch) {
        _push(`<p class="text-red-500 text-sm mt-2" data-v-38bcf261> Passwords do not match. </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="w-full text-white py-3 mt-4 rounded bg-red-600"${ssrIncludeBooleanAttr($options.passwordMismatch) ? " disabled" : ""} data-v-38bcf261> Reset Password </button></div>`);
    }
    _push(`</div>`);
  }
  _push(`</div></div><div class="hidden md:block h-full w-full p-4 relative" data-v-38bcf261>`);
  _push(ssrRenderComponent(_component_Carousel, {
    verticalViewPortHeight: 2e3,
    value: $data.images,
    numVisible: 1,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="relative w-full h-screen flex justify-center items-center" data-v-38bcf261${_scopeId}><img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-xl object-cover w-100 h-100" data-v-38bcf261${_scopeId}><div class="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white py-2 px-4 rounded" data-v-38bcf261${_scopeId}>${ssrInterpolate(slotProps.data.alt)}</div></div>`);
      } else {
        return [
          createVNode("div", { class: "relative w-full h-screen flex justify-center items-center" }, [
            createVNode("img", {
...
const LoginForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-38bcf261"]]);
...
//# sourceMappingURL=index-CJOyp5cq.mjs.map
