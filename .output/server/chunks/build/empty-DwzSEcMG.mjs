...
import { useSSRContext, mergeProps, ref, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, unref, createElementBlock, renderSlot, createCommentVNode, createElementVNode } from 'vue';
...
import { s as script$3 } from './index-jtFS_Qvq.mjs';
import { useRouter } from 'vue-router';
import { s as script$5 } from './index-DMVaXLtj.mjs';
import { a as script$1$2 } from './index-BjfqnR8d.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-DpsmJg1c.mjs';
import { s as script$4 } from './index-DcyyOm7X.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex gap-6 p-4" }, _attrs))} data-v-945a3954><div class="w-1/5 bg-white shadow p-4 rounded-lg relative h-32 sm:h-40 md:h-80 xl:h-80 hidden lg:block" data-v-945a3954>`);
      if (__props.categories.length) {
        _push(`<ul class="space-y-2" data-v-945a3954><!--[-->`);
        ssrRenderList(__props.categories, (item) => {
          _push(`<li class="flex items-center gap-2 pt-3 hover:text-primary cursor-pointer font-regular" data-v-945a3954><i class="${ssrRenderClass(getIcon(item.name))}" data-v-945a3954></i><span class="text-xs truncate" data-v-945a3954>${ssrInterpolate(item.name)}</span></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<p class="text-gray-50 text-xs text-center pt-3" data-v-945a3954><!--[-->`);
        ssrRenderList(9, (i) => {
          _push(ssrRenderComponent(_component_Skeleton, { class: "mb-2 p-3" }, null, _parent));
        });
        _push(`<!--]--></p>`);
      }
      _push(`</div><div class="flex-1 bg-white shadow rounded-lg relative w-full h-32 sm:h-40 md:h-80 xl:h-80" data-v-945a3954><div class="flex items-center gap-6 relative" data-v-945a3954>`);
      if (unref(hoveredCategory)) {
        _push(`<div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-white text-2xl font-bold transition-opacity duration-300 rounded w-full h-32 sm:h-40 md:h-80 xl:h-80" data-v-945a3954>${ssrInterpolate(unref(hoveredCategory))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(hoveredCategory)) {
        _push(ssrRenderComponent(_component_Carousel, {
          ...
          item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-lg object-cover w-full h-32 sm:h-40 md:h-80 xl:h-80" data-v-945a3954${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
      ...
      _push(`<div class="bg-black text-white px-4 py-2 sm:px-6 sm:py-3 md:px-6 md:py-4 rounded-lg absolute bottom-2 sm:bottom-4 md:bottom-6 right-2 sm:right-4 md:right-6 w-auto max-w-[70%] sm:max-w-[60%] md:max-w-[50%]" data-v-945a3954><h2 class="text-xs sm:text-sm md:text-base font-bold" style="${ssrRenderStyle({ "font-family": "sans-serif" })}" data-v-945a3954> Break from <br data-v-945a3954> reality </h2><p class="text-[10px] sm:text-xs md:text-sm text-gray-400" style="${ssrRenderStyle({ "font-family": "monospace" })}" data-v-945a3954> HD and Audio </p><button class="bg-primary text-white text-xs sm:text-sm md:text-base px-4 sm:px-6 py-1 sm:py-2 mt-3 sm:mt-4 rounded-lg" data-v-945a3954> Shop Now </button></div></div></div><div class="w-1/5 space-y-4 hidden lg:block h-32 lg:h-80 xl:h-80" data-v-945a3954><div class="bg-white shadow p-4 rounded-lg" data-v-945a3954><h4 class="text-primary font-bold" data-v-945a3954>HELP CENTER</h4><p class="text-gray-600 text-sm" data-v-945a3954>Guide to Customer Care</p><h4 class="text-primary font-bold" data-v-945a3954>HOT DEALS</h4><p class="text-gray-600 text-sm" data-v-945a3954>Updated Daily</p></div><div class="bg-primary text-white text-center p-6 rounded-lg" data-v-945a3954><p class="font-bold text-lg" data-v-945a3954>CALL OR WHATSAPP</p><p class="text-2xl font-bold" data-v-945a3954>+254 727 909 060</p><p class="text-sm" data-v-945a3954>TO ORDER</p></div></div></div>`);
    };
  }
};
...
const TopCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-945a3954"]]);
const _sfc_main$1 = {};
          ...
          if (_push2) {
            ...
            ssrRenderList(__props.features, (filter, index) => {
              ...
              _push2(ssrRenderComponent(_component_Checkbox, {
                modelValue: filter.description,
                "onUpdate:modelValue": ($event) => filter.description = $event,
                value: filter.description,
                class: "mr-2"
              }, null, _parent2, _scopeId));
              _push2(`<label${ssrRenderAttr("for", filter.description)}${_scopeId}>${ssrInterpolate(filter.description)}</label></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
              createVNode("div", { class: "space-y-2" }, [
                (openBlock(true), createBlock(Fragment, null, renderList(__props.features, (filter, index) => {
                  return openBlock(), createBlock("div", {
                    ...
                    }, toDisplayString(filter.description), 9, ["for"])
                  ]);
                }), 128))
              ])
            ];
...
//# sourceMappingURL=empty-DwzSEcMG.mjs.map
