...
import { s as script$h } from './index-DJ-ZgwLv.mjs';
import { s as script$g } from './index-CzrJQldg.mjs';
import { isTouchDevice, addStyle, relativePosition, getOuterWidth, absolutePosition, find, findSingle } from '@primeuix/utils/dom';
import { s as script$7$1, a as script$f, U as UniqueComponentId, C as ConnectedOverlayScrollHandler, O as OverlayEventBus } from './index-NgWSRoHh.mjs';
...
import { s as script$i } from './index-CEOEMxBM.mjs';
import { ZIndex } from '@primeuix/utils/zindex';
import { s as script$3$1 } from './index-CPSBx0zQ.mjs';
import { s as script$k } from './index-C-aCq1t3.mjs';
import { equals, findIndexInList } from '@primeuix/utils/object';
import { s as script$j } from './index-DW__Wuaq.mjs';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_Button = script$i;
  const _component_InputOtp = script$d;
  const _component_Carousel = script$g;
  const _component_Toast = script$h;
...
var _hoisted_1$1 = ["data-p-checked", "data-p-disabled"];
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "class": _ctx.cx("icon")
  }, $options.getPTOptions("icon")), null, 16)], 16)], 16, _hoisted_1$1);
}
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-8c652570><div class="flex w-full flex-col items-center justify-center" data-v-8c652570><div class="flex justify-center items-center absolute top-16 left-8" data-v-8c652570><a class="text-primary text-md cursor-pointer hover:text-secondary" data-v-8c652570><i class="pi pi-arrow-left text-primary pr-2 hover:text-secondary" style="${ssrRenderStyle({})}" data-v-8c652570></i> Back to Signup</a></div><div class="border shadow-xl mt-36 p-6 lg:ml-16 rounded-xl bg-white" data-v-8c652570>`);
            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row flex-auto gap-2" }, a11yAttrs3.root))} data-v-8c652570${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-8c652570${_scopeId3}><span class="${ssrRenderClass([
                    ...
                    ])}" data-v-8c652570${_scopeId3}><i class="pi pi-building" data-v-8c652570${_scopeId3}></i></span></button>`);
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row flex-auto gap-2 pl-2" }, a11yAttrs3.root))} data-v-8c652570${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-8c652570${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-8c652570${_scopeId3}><i class="pi pi-cog" data-v-8c652570${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row pl-2" }, a11yAttrs3.root))} data-v-8c652570${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-8c652570${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-8c652570${_scopeId3}><i class="pi pi-question-circle" data-v-8c652570${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    ])}" data-v-8c652570${_scopeId3}><i class="pi pi-check-circle" data-v-8c652570${_scopeId3}></i></span></button></div>`);
                  } else {
                    return [
                      createVNode("div", mergeProps({ class: "flex flex-row pl-2" }, a11yAttrs3.root), [
                        createVNode("button", mergeProps({
            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_StepPanel, { value: 1 }, {
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4 mx-auto" style="${ssrRenderStyle({ "min-width": "40vw" })}" data-v-8c652570${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-8c652570${_scopeId3}> Section 1: Business Identification </div><div class="flex gap-4" data-v-8c652570${_scopeId3}><div class="field w-1/2" data-v-8c652570${_scopeId3}><label for="firstName" class="font-bold" data-v-8c652570${_scopeId3}>First Name</label>`);
                    ...
                    if ($data.errors.firstName) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.firstName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-8c652570${_scopeId3}><label for="lastName" class="font-bold" data-v-8c652570${_scopeId3}>Last Name</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "lastName",
                    ...
                    if ($data.errors.lastName) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.lastName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-8c652570${_scopeId3}><div class="field w-1/2" data-v-8c652570${_scopeId3}><label for="phoneNumber" class="font-bold" data-v-8c652570${_scopeId3}>Phone Number</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "phoneNumber",
                    ...
                    if ($data.errors.phoneNumber) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.phoneNumber)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-8c652570${_scopeId3}><label for="email" class="font-bold" data-v-8c652570${_scopeId3}>Email Address</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "email",
                    ...
                    if ($data.errors.email) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.email)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-8c652570${_scopeId3}><div class="field w-1/2" data-v-8c652570${_scopeId3}><label for="businessName" class="font-bold" data-v-8c652570${_scopeId3}>Business/Company Name</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "businessName",
                    ...
                    if ($data.errors.businessName) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.businessName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-8c652570${_scopeId3}><label for="location" class="font-bold" data-v-8c652570${_scopeId3}>Business Location</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "location",
                    ...
                    if ($data.errors.location) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.location)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex flex-col gap-4" data-v-8c652570${_scopeId3}><div class="font-bold mb-2" data-v-8c652570${_scopeId3}>Business Type</div><div class="flex flex-wrap gap-4" data-v-8c652570${_scopeId3}><!--[-->`);
                    ssrRenderList($data.businessCategories, (category) => {
                      _push4(`<div class="flex items-center gap-2" data-v-8c652570${_scopeId3}>`);
                      ...
                      _push4(`<label${ssrRenderAttr("for", category.key)} data-v-8c652570${_scopeId3}>${ssrInterpolate(category.name)}</label></div>`);
                    });
                    _push4(`<!--]-->`);
                    if ($data.errors.businessType) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.businessType)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div data-v-8c652570${_scopeId3}><div class="font-bold mb-2" data-v-8c652570${_scopeId3}>Years of Experience</div><div class="flex flex-wrap gap-4" data-v-8c652570${_scopeId3}><!--[-->`);
                    ...
                    if ($data.errors.experienceYears) {
                      _push4(`<small class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors.experienceYears)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div></div><div class="flex pt-6 justify-end" style="${ssrRenderStyle({ "max-width": "800px", "margin": "0 auto" })}" data-v-8c652570${_scopeId3}>`);
              ...
              _push3(ssrRenderComponent(_component_StepPanel, {
                ...
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4" data-v-8c652570${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-8c652570${_scopeId3}> Section 2: Technical Experience </div><div data-v-8c652570${_scopeId3}><label class="font-bold py-5" data-v-8c652570${_scopeId3}> Which of the following areas do you have experience with? </label><!--[-->`);
                    ...
                    if ($data.experienceAreasError) {
                      _push4(`<p class="text-red-500" data-v-8c652570${_scopeId3}> Please select at least one area of experience. </p>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div data-v-8c652570${_scopeId3}><label class="font-bold pb-3" data-v-8c652570${_scopeId3}> Which brands have you primarily worked with? </label><!--[-->`);
                    ...
                    if ($data.brandsWorkedWithError) {
                      _push4(`<p class="text-red-500" data-v-8c652570${_scopeId3}> Please select at least one brand. </p>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field" data-v-8c652570${_scopeId3}><label class="font-bold pb-3" data-v-8c652570${_scopeId3}> Do you have experience integrating security systems into larger solutions? </label><!--[-->`);
                    ...
                    if ($data.integrationExperienceError) {
                      _push4(`<p class="text-red-500" data-v-8c652570${_scopeId3}> Please select an option. </p>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field" data-v-8c652570${_scopeId3}><label class="font-bold pb-3" data-v-8c652570${_scopeId3}> Are you familiar with Hikvision product certifications and installation standards? </label><!--[-->`);
                    ...
                    _push4(`</div></div><div class="flex pt-6 justify-between" data-v-8c652570${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
              ...
              _push3(ssrRenderComponent(_component_StepPanel, {
                ...
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4" data-v-8c652570${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-8c652570${_scopeId3}> Section 3: Technical Questions </div><div class="field" data-v-8c652570${_scopeId3}><label for="purchaseSource" class="font-bold pb-3" data-v-8c652570${_scopeId3}> Where do you currently purchase your security products? (Please select all that apply and provide details for each category) </label><!--[-->`);
                    ...
                    _push4(`</div><div class="field" data-v-8c652570${_scopeId3}><label class="font-bold pb-3" data-v-8c652570${_scopeId3}> Do you currently purchase Hikvision products? </label><!--[-->`);
                    ...
                    ssrRenderList($data.textareaFields, (field) => {
                      var _a;
                      _push4(`<div class="field" data-v-8c652570${_scopeId3}><label class="font-bold pb-3" data-v-8c652570${_scopeId3}><span data-v-8c652570${_scopeId3}>${(_a = field.label) != null ? _a : ""}</span></label>`);
                      _push4(ssrRenderComponent(_component_IftaLabel, { class: "mt-4" }, {
                        default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            ...
                            _push5(`<label${ssrRenderAttr("for", field.id)} data-v-8c652570${_scopeId4}>Summary</label>`);
                          } else {
                            return [
                      ...
                      if ($data.errors[field.model]) {
                        _push4(`<p class="text-red-500" data-v-8c652570${_scopeId3}>${ssrInterpolate($data.errors[field.model])}</p>`);
                      } else {
                        _push4(`<!---->`);
                      }
                      _push4(`</div>`);
                    });
                    _push4(`<!--]--></div><div class="flex pt-6 justify-between" data-v-8c652570${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
                      icon: "pi pi-arrow-left",
              ...
              _push3(ssrRenderComponent(_component_StepPanel, { value: 4 }, {
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4 mx-auto w-full max-w-lg min-h-[20rem]" data-v-8c652570${_scopeId3}><div class="text-center mt-4 mb-4 text-sm font-semibold" data-v-8c652570${_scopeId3}><div class="p-6 rounded-lg shadow-md" data-v-8c652570${_scopeId3}> Thank You! <p class="text-gray-700" data-v-8c652570${_scopeId3}> Your application will undergo a thorough review. Upon successful verification, you will gain access to: </p><ul class="list-disc text-left pl-5 text-gray-700 mt-3" data-v-8c652570${_scopeId3}><li data-v-8c652570${_scopeId3}><strong data-v-8c652570${_scopeId3}>Reseller Pricing</strong></li><li data-v-8c652570${_scopeId3}><strong data-v-8c652570${_scopeId3}>Comprehensive Marketing and Technical Resources</strong></li><li data-v-8c652570${_scopeId3}><strong data-v-8c652570${_scopeId3}>Product and Business Support</strong></li></ul><p class="text-gray-700 mt-4" data-v-8c652570${_scopeId3}> For any inquiries or further assistance, please do not hesitate to contact us: </p><div class="bg-white p-4 rounded-lg shadow mt-4" data-v-8c652570${_scopeId3}><p class="text-gray-800 font-semibold" data-v-8c652570${_scopeId3}> \u{1F4E7} Email: <a href="mailto:sdl@hikvisionkenya.com" class="text-blue-600 hover:underline" data-v-8c652570${_scopeId3}>sdl@hikvisionkenya.com</a></p><p class="text-gray-800 font-semibold" data-v-8c652570${_scopeId3}> \u{1F4DE} Phone: <a href="tel:+254727909060" class="text-blue-600 hover:underline" data-v-8c652570${_scopeId3}>+254 727 909 060</a></p></div><p class="text-gray-700 mt-6" data-v-8c652570${_scopeId3}> We look forward to the opportunity to collaborate with you. </p><hr class="my-4 border-gray-300" data-v-8c652570${_scopeId3}><p class="text-gray-800 font-bold" data-v-8c652570${_scopeId3}>Best regards,</p><p class="text-gray-700" data-v-8c652570${_scopeId3}> Secure Digital Limited | Hik Digital Mart Limited </p><p class="text-gray-700 font-semibold" data-v-8c652570${_scopeId3}> SDLKenya Online Shop Administration Department </p><div class="bg-white p-4 rounded-lg shadow mt-4" data-v-8c652570${_scopeId3}><p class="text-gray-800 font-semibold" data-v-8c652570${_scopeId3}> \u{1F4E7} Email: <a href="mailto:sdl@hikvisionkenya.com" class="text-blue-600 hover:underline" data-v-8c652570${_scopeId3}>sdl@hikvisionkenya.com</a></p><p class="text-gray-800 font-semibold" data-v-8c652570${_scopeId3}> \u{1F4DE} Phone: <a href="tel:+254727909060" class="text-blue-600 hover:underline" data-v-8c652570${_scopeId3}>+254 727 909 060</a></p></div></div></div></div><div class="flex pt-6 justify-between" data-v-8c652570${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
                      icon: "pi pi-arrow-left",
  ...
  _push(`</div></div><div class="hidden md:block h-full w-full" data-v-8c652570>`);
  _push(ssrRenderComponent(_component_Carousel, {
    verticalViewPortHeight: 2e3,
    autoplayInterval: 4e3,
    value: $data.images,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="relative w-full h-screen flex justify-center items-center" data-v-8c652570${_scopeId}><img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-xl object-cover w-100 h-100" data-v-8c652570${_scopeId}><div class="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white py-2 px-4 rounded" data-v-8c652570${_scopeId}>${ssrInterpolate(slotProps.data.alt)}</div></div>`);
      } else {
        return [
          createVNode("div", { class: "relative w-full h-screen flex justify-center items-center" }, [
            createVNode("img", {
...
const QuestionnaireForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-8c652570"]]);
const _sfc_main$1 = {
  data() {
    return {
      responseMessage: {},
  ...
  methods: {
    handleSubmit(activateCallback) {
      const data6 = { ...this.wholesalerPersonalInfo, ...this.wholesalerBusinessInfo, ...this.wholesalerTechnicalInfo };
      if (this.validateForm()) {
        console.log("Form Data:", data6);
        this.submitForm();
      } else {
        console.log("Validation failed");
      }
    ...
    hasErrors(obj) {
      return Object.values(obj).some((value2) => {
        if (typeof value2 === "object") {
          return this.hasErrors(value2);
        }
        return value2 !== "";
      });
    },
    validateAndProceed(activateCallback, x) {
      ...
      if (x == 2) {
        ...
        if (!this.selectedBrandsError && !this.selectedBusinessTypeErrors && !this.selectedSecurityBrandsError) {
          activateCallback(3);
        }
      }
    },
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "flex w-full align-center justify-center",
    style: { "background-image": "url('https://www.sdl.co.ke/assets/images/icons/vector-1.png')" }
  }, _attrs))} data-v-9971bf55><div class="flex w-full flex-col items-center justify-center" data-v-9971bf55><div class="flex justify-center items-center absolute top-16 left-8" data-v-9971bf55><a class="text-primary text-md cursor-pointer hover:text-secondary" data-v-9971bf55><i class="pi pi-arrow-left text-primary pr-2 hover:text-secondary" style="${ssrRenderStyle({})}" data-v-9971bf55></i> Back to Signup</a></div><div class="border shadow-xl mt-36 p-6 lg:ml-16 rounded-xl bg-white" data-v-9971bf55>`);
  _push(ssrRenderComponent(_component_Stepper, {
    value: $data.activeStep,
    "onUpdate:value": ($event) => $data.activeStep = $event,
    class: ""
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row flex-auto gap-2" }, a11yAttrs3.root))} data-v-9971bf55${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-9971bf55${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-9971bf55${_scopeId3}><i class="pi pi-building" data-v-9971bf55${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row flex-auto gap-2 pl-2" }, a11yAttrs3.root))} data-v-9971bf55${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-9971bf55${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-9971bf55${_scopeId3}><i class="pi pi-cog" data-v-9971bf55${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row pl-2" }, a11yAttrs3.root))} data-v-9971bf55${_scopeId3}><button${ssrRenderAttrs(mergeProps({ class: "bg-transparent border-0 inline-flex flex-col gap-2" }, a11yAttrs3.header))} data-v-9971bf55${_scopeId3}><span class="${ssrRenderClass([
                      "rounded-full border-2 w-12 h-12 inline-flex items-center justify-center",
                      {
                        "bg-primary text-primary-contrast border-primary": value2 <= $data.activeStep,
                        "border-surface-200 dark:border-surface-700": value2 > $data.activeStep
                      }
                    ])}" data-v-9971bf55${_scopeId3}><i class="pi pi-question-circle" data-v-9971bf55${_scopeId3}></i></span></button>`);
                    _push4(ssrRenderComponent(_component_Divider, null, null, _parent4, _scopeId3));
                    _push4(`</div>`);
                  } else {
                    return [
              ...
              _push3(ssrRenderComponent(_component_Step, {
                ...
                default: withCtx(({ activateCallback, value: value2, a11yAttrs: a11yAttrs3 }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    ])}" data-v-9971bf55${_scopeId3}><i class="pi pi-check-circle" data-v-9971bf55${_scopeId3}></i></span></button></div>`);
                  } else {
                    return [
                      createVNode("div", mergeProps({ class: "flex flex-row pl-2" }, a11yAttrs3.root), [
                        createVNode("button", mergeProps({
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_StepPanel, { value: 1 }, {
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4 mx-auto" style="${ssrRenderStyle({ "min-width": "40vw" })}" data-v-9971bf55${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-9971bf55${_scopeId3}> Section 1: Personal Information </div><div class="flex gap-4" data-v-9971bf55${_scopeId3}><div class="field w-full" data-v-9971bf55${_scopeId3}><label for="firstName" class="font-bold" data-v-9971bf55${_scopeId3}>Company Name ( Full company name )</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.companyName",
                    ...
                    if ($data.errors.wholesalerPersonalInfo.companyName) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.companyName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-9971bf55${_scopeId3}><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="firstName" class="font-bold" data-v-9971bf55${_scopeId3}>First Name</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.firstName",
                    ...
                    if ($data.errors.wholesalerPersonalInfo.firstName) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.firstName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="wholesalerPersonalInfo.lastName" class="font-bold" data-v-9971bf55${_scopeId3}>Last Name</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.lastName",
                    ...
                    if ($data.errors.wholesalerPersonalInfo.lastName) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.lastName)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-9971bf55${_scopeId3}><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="wholesalerPersonalInfo.email" class="font-bold" data-v-9971bf55${_scopeId3}>Email Address</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.email",
                    ...
                    if ($data.errors.wholesalerPersonalInfo.email) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.email)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="wholesalerPersonalInfo.email2" class="font-bold" data-v-9971bf55${_scopeId3}>Email Address 2</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.email2",
                      modelValue: $data.wholesalerPersonalInfo.email2,
                      "onUpdate:modelValue": ($event) => $data.wholesalerPersonalInfo.email2 = $event,
                      type: "email",
                      placeholder: "Enter email 2 address",
                      class: "w-full"
                    }, null, _parent4, _scopeId3));
                    if ($data.errors.wholesalerPersonalInfo.email2) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.email2)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-9971bf55${_scopeId3}><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="wholesalerPersonalInfo.phoneNumber" class="font-bold" data-v-9971bf55${_scopeId3}>Phone Number 1</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.phoneNumber",
                    ...
                    if ($data.errors.wholesalerPersonalInfo.phoneNumber) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.phoneNumber)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="wholesalerPersonalInfo.phoneNumber2" class="font-bold" data-v-9971bf55${_scopeId3}>Phone Number 2</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.phoneNumber2",
                    ...
                    if ($data.errors.wholesalerPersonalInfo.phoneNumber2) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.phoneNumber2)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div><div class="flex gap-4" data-v-9971bf55${_scopeId3}><div class="field w-1/2" data-v-9971bf55${_scopeId3}><label for="wholesalerPersonalInfo.address" class="font-bold" data-v-9971bf55${_scopeId3}>Business Address</label>`);
                    _push4(ssrRenderComponent(_component_InputText, {
                      id: "wholesalerPersonalInfo.address",
                      modelValue: $data.wholesalerPersonalInfo.address,
                      "onUpdate:modelValue": ($event) => $data.wholesalerPersonalInfo.address = $event,
                      type: "text",
                      placeholder: "Shop Location i.e Shop no, Building name, Street & Town",
                      class: "w-full"
                    }, null, _parent4, _scopeId3));
                    if ($data.errors.wholesalerPersonalInfo.address) {
                      _push4(`<small class="text-red-500" data-v-9971bf55${_scopeId3}>${ssrInterpolate($data.errors.wholesalerPersonalInfo.address)}</small>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div></div><div class="flex pt-6 justify-end" style="${ssrRenderStyle({ "max-width": "800px", "margin": "0 auto" })}" data-v-9971bf55${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Next",
                      icon: "pi pi-arrow-right",
                      iconPos: "right",
                      ...
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "flex gap-4" }, [
                          createVNode("div", { class: "field w-full" }, [
                            ...
                            $data.errors.wholesalerPersonalInfo.companyName ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.companyName), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode("div", { class: "flex gap-4" }, [
                          createVNode("div", { class: "field w-1/2" }, [
                            ...
                            $data.errors.wholesalerPersonalInfo.firstName ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.firstName), 1)) : createCommentVNode("", true)
                          ]),
                          createVNode("div", { class: "field w-1/2" }, [
                            createVNode("label", {
                              for: "wholesalerPersonalInfo.lastName",
                              class: "font-bold"
                            }, "Last Name"),
                            createVNode(_component_InputText, {
                              id: "wholesalerPersonalInfo.lastName",
                            ...
                            $data.errors.wholesalerPersonalInfo.lastName ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.lastName), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode("div", { class: "flex gap-4" }, [
                          createVNode("div", { class: "field w-1/2" }, [
                            createVNode("label", {
                              for: "wholesalerPersonalInfo.email",
                              class: "font-bold"
                            }, "Email Address"),
                            createVNode(_component_InputText, {
                              id: "wholesalerPersonalInfo.email",
                            ...
                            $data.errors.wholesalerPersonalInfo.email ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.email), 1)) : createCommentVNode("", true)
                          ]),
                          createVNode("div", { class: "field w-1/2" }, [
                            createVNode("label", {
                              for: "wholesalerPersonalInfo.email2",
                              class: "font-bold"
                            }, "Email Address 2"),
                            createVNode(_component_InputText, {
                              id: "wholesalerPersonalInfo.email2",
                            ...
                            $data.errors.wholesalerPersonalInfo.email2 ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.email2), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode("div", { class: "flex gap-4" }, [
                          createVNode("div", { class: "field w-1/2" }, [
                            createVNode("label", {
                              for: "wholesalerPersonalInfo.phoneNumber",
                              class: "font-bold"
                            }, "Phone Number 1"),
                            createVNode(_component_InputText, {
                              id: "wholesalerPersonalInfo.phoneNumber",
                            ...
                            $data.errors.wholesalerPersonalInfo.phoneNumber ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.phoneNumber), 1)) : createCommentVNode("", true)
                          ]),
                          createVNode("div", { class: "field w-1/2" }, [
                            createVNode("label", {
                              for: "wholesalerPersonalInfo.phoneNumber2",
                              class: "font-bold"
                            }, "Phone Number 2"),
                            createVNode(_component_InputText, {
                              id: "wholesalerPersonalInfo.phoneNumber2",
                            ...
                            $data.errors.wholesalerPersonalInfo.phoneNumber2 ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.phoneNumber2), 1)) : createCommentVNode("", true)
                          ])
                        ]),
                        createVNode("div", { class: "flex gap-4" }, [
                          createVNode("div", { class: "field w-1/2" }, [
                            createVNode("label", {
                              for: "wholesalerPersonalInfo.address",
                              class: "font-bold"
                            }, "Business Address"),
                            createVNode(_component_InputText, {
                              id: "wholesalerPersonalInfo.address",
                            ...
                            $data.errors.wholesalerPersonalInfo.address ? (openBlock(), createBlock("small", {
                              key: 0,
                              class: "text-red-500"
                            }, toDisplayString($data.errors.wholesalerPersonalInfo.address), 1)) : createCommentVNode("", true)
                          ])
                        ])
                      ]),
                      createVNode("div", {
              ...
              _push3(ssrRenderComponent(_component_StepPanel, {
                ...
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4" data-v-9971bf55${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-9971bf55${_scopeId3}> Section 2: Business Details </div><div data-v-9971bf55${_scopeId3}><label class="font-bold py-5" data-v-9971bf55${_scopeId3}> Which of the following describes your business well? </label> ${ssrInterpolate($data.wholesalerBusinessInfo.selectedBusinessType)} <!--[-->`);
                    ssrRenderList($data.businessTypes, (type) => {
                      _push4(`<div class="flex items-center gap-2" data-v-9971bf55${_scopeId3}>`);
                      _push4(ssrRenderComponent(_component_RadioButton, {
                        ...
                        inputId: type.key,
                        name: "selectedBrands.businessType",
                        value: type.name
                      }, null, _parent4, _scopeId3));
                      _push4(`<label${ssrRenderAttr("for", type.key)} data-v-9971bf55${_scopeId3}>${ssrInterpolate(type.name)}</label></div>`);
                    });
                    _push4(`<!--]-->`);
                    ...
                    _push4(`</div><div data-v-9971bf55${_scopeId3}><label class="font-bold pb-3" data-v-9971bf55${_scopeId3}> Which brands do you deal with? </label><!--[-->`);
                    ssrRenderList($data.brandList, (brand) => {
                      ...
                      _push4(ssrRenderComponent(_component_Checkbox, {
                        ...
                        inputId: brand.key,
                        name: "wholesalerBusinessInfo.selectedBrands",
                        value: brand.name
                      }, null, _parent4, _scopeId3));
                      _push4(`<label${ssrRenderAttr("for", brand.key)} data-v-9971bf55${_scopeId3}>${ssrInterpolate(brand.name)}</label></div>`);
                    });
                    _push4(`<!--]-->`);
                    ...
                    _push4(`</div><div data-v-9971bf55${_scopeId3}><label class="font-bold pb-3" data-v-9971bf55${_scopeId3}> Which security brand do you have strength in? </label><!--[-->`);
                    ssrRenderList($data.securityBrands, (brand) => {
                      ...
                      _push4(ssrRenderComponent(_component_Checkbox, {
                        ...
                        inputId: brand.key,
                        name: "wholesalerBusinessInfo.selectedSecurityBrands",
                        value: brand.name
                      }, null, _parent4, _scopeId3));
                      _push4(`<label${ssrRenderAttr("for", brand.key)} data-v-9971bf55${_scopeId3}>${ssrInterpolate(brand.name)}</label></div>`);
                    });
                    _push4(`<!--]--></div></div><div class="flex pt-6 justify-between" data-v-9971bf55${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
                      icon: "pi pi-arrow-left",
                    ...
                    return [
                      createVNode("div", { class: "flex flex-col gap-4" }, [
                        ...
                        createVNode("div", null, [
                          ...
                          createTextVNode(" " + toDisplayString($data.wholesalerBusinessInfo.selectedBusinessType) + " ", 1),
              ...
              _push3(ssrRenderComponent(_component_StepPanel, {
                ...
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4" data-v-9971bf55${_scopeId3}><div class="text-center mt-4 mb-4 text-xl font-semibold" data-v-9971bf55${_scopeId3}> Section 3: Technical Questions </div><div data-v-9971bf55${_scopeId3}><label class="font-bold pb-3" data-v-9971bf55${_scopeId3}> Which product categories do you mostly deal with? </label><!--[-->`);
                    ssrRenderList($data.productCategories, (category) => {
                      ...
                      _push4(`<label${ssrRenderAttr("for", category.key)} data-v-9971bf55${_scopeId3}>${ssrInterpolate(category.name)}</label></div>`);
                    });
                    _push4(`<!--]--></div><div data-v-9971bf55${_scopeId3}><label class="font-bold pb-3" data-v-9971bf55${_scopeId3}>What are the challenges you have faced when dealing with Hikvision?</label>`);
                    ...
                    _push4(`</div><div data-v-9971bf55${_scopeId3}><label class="font-bold pb-3" data-v-9971bf55${_scopeId3}>What would be your advice to Secure Digital Limited?</label>`);
                    _push4(ssrRenderComponent(_component_Textarea, {
              ...
              _push3(ssrRenderComponent(_component_StepPanel, { value: 4 }, {
                default: withCtx(({ activateCallback }, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="flex flex-col gap-4 mx-auto w-full max-w-lg min-h-[20rem]" data-v-9971bf55${_scopeId3}><div class="text-center mt-4 mb-4 text-sm font-semibold" data-v-9971bf55${_scopeId3}><div class="p-6 rounded-lg shadow-md" data-v-9971bf55${_scopeId3}> Thank You! <p class="text-gray-700" data-v-9971bf55${_scopeId3}> Your application will undergo a thorough review. Upon successful verification, you will gain access to: </p><ul class="list-disc text-left pl-5 text-gray-700 mt-3" data-v-9971bf55${_scopeId3}><li data-v-9971bf55${_scopeId3}><strong data-v-9971bf55${_scopeId3}>Reseller Pricing</strong></li><li data-v-9971bf55${_scopeId3}><strong data-v-9971bf55${_scopeId3}>Comprehensive Marketing and Technical Resources</strong></li><li data-v-9971bf55${_scopeId3}><strong data-v-9971bf55${_scopeId3}>Product and Business Support</strong></li></ul><p class="text-gray-700 mt-4" data-v-9971bf55${_scopeId3}> For any inquiries or further assistance, please do not hesitate to contact us: </p><div class="bg-white p-4 rounded-lg shadow mt-4" data-v-9971bf55${_scopeId3}><p class="text-gray-800 font-semibold" data-v-9971bf55${_scopeId3}> \u{1F4E7} Email: <a href="mailto:sdl@hikvisionkenya.com" class="text-blue-600 hover:underline" data-v-9971bf55${_scopeId3}>sdl@hikvisionkenya.com</a></p><p class="text-gray-800 font-semibold" data-v-9971bf55${_scopeId3}> \u{1F4DE} Phone: <a href="tel:+254727909060" class="text-blue-600 hover:underline" data-v-9971bf55${_scopeId3}>+254 727 909 060</a></p></div><p class="text-gray-700 mt-6" data-v-9971bf55${_scopeId3}> We look forward to the opportunity to collaborate with you. </p><hr class="my-4 border-gray-300" data-v-9971bf55${_scopeId3}><p class="text-gray-800 font-bold" data-v-9971bf55${_scopeId3}>Best regards,</p><p class="text-gray-700" data-v-9971bf55${_scopeId3}> Secure Digital Limited | Hik Digital Mart Limited </p><p class="text-gray-700 font-semibold" data-v-9971bf55${_scopeId3}> SDLKenya Online Shop Administration Department </p><div class="bg-white p-4 rounded-lg shadow mt-4" data-v-9971bf55${_scopeId3}><p class="text-gray-800 font-semibold" data-v-9971bf55${_scopeId3}> \u{1F4E7} Email: <a href="mailto:sdl@hikvisionkenya.com" class="text-blue-600 hover:underline" data-v-9971bf55${_scopeId3}>sdl@hikvisionkenya.com</a></p><p class="text-gray-800 font-semibold" data-v-9971bf55${_scopeId3}> \u{1F4DE} Phone: <a href="tel:+254727909060" class="text-blue-600 hover:underline" data-v-9971bf55${_scopeId3}>+254 727 909 060</a></p></div></div></div></div><div class="flex pt-6 justify-between" data-v-9971bf55${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_Button, {
                      label: "Back",
                      severity: "secondary",
                      icon: "pi pi-arrow-left",
  ...
  _push(`</div></div><div class="hidden md:block h-full w-full" data-v-9971bf55>`);
  _push(ssrRenderComponent(_component_Carousel, {
    verticalViewPortHeight: 2e3,
    autoplayInterval: 4e3,
    value: $data.images,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="relative w-full h-screen flex justify-center items-center" data-v-9971bf55${_scopeId}><img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-xl object-cover w-100 h-100" data-v-9971bf55${_scopeId}><div class="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white py-2 px-4 rounded" data-v-9971bf55${_scopeId}>${ssrInterpolate(slotProps.data.alt)}</div></div>`);
      } else {
        return [
          createVNode("div", { class: "relative w-full h-screen flex justify-center items-center" }, [
            createVNode("img", {
...
const WholesalerForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-9971bf55"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const showWholesaler = ref(false);
    const toggleForm = () => {
...
//# sourceMappingURL=index-DSxHd8Em.mjs.map
