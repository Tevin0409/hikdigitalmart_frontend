...
const _routes = [
  ...
  },
  {
    name: "auth",
    path: "/auth",
    component: () => import('./index-Jn560z5s.mjs')
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./index-BfKox2tB.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./index-BSgKfz7z.mjs')
  },
  {
    name: "Dashboard",
    path: "/Dashboard",
    component: () => import('./Dashboard-D5q33Qwr.mjs')
  },
  {
    name: "Home",
    path: "/Home",
    component: () => import('./Home-C3bWLVrs.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-ByNIBwuX.mjs')
  },
  {
    name: "my-account",
    path: "/my-account",
  ...
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./index-BD5iS_KG.mjs')
  },
  {
    name: "Profile",
    path: "/Profile",
  ...
  },
  {
    name: "results-id",
    path: "/results/:id()",
    component: () => import('./_id_-DJ9ZRJCA.mjs')
  },
  {
    name: "wishlist",
    path: "/wishlist",
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-B1oVCkHg.mjs')),
  default: defineAsyncComponent(() => import('./default-BvEg8sSo.mjs')),
  landing: defineAsyncComponent(() => import('./landing-BIoLEHvT.mjs')),
  login: defineAsyncComponent(() => import('./login-DCkDX7FH.mjs'))
};
...
export { BaseStyle as B, FilterService as F, PrimeVueService as P, ToastEventBus as T, _export_sfc as _, useNuxtApp as a, useProductStore as b, useRouter as c, resolveRouteObject as d, entry$1 as default, navigateTo as e, useRuntimeConfig as f, useToast as g, FilterOperator as h, injectHead as i, FilterMatchMode as j, defineNuxtRouteMiddleware as k, __nuxt_component_0 as l, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useUserStore as u };
