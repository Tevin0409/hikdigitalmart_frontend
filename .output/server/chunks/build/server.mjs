...
const _routes = [
  ...
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./index-BGmZzr9J.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./index-BswLoyDw.mjs')
  },
  {
    name: "Dashboard",
    path: "/Dashboard",
    component: () => import('./Dashboard-BB3xHsEB.mjs')
  },
  {
    name: "Home",
    path: "/Home",
    component: () => import('./Home-D4A8rmA_.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BzyF6ED2.mjs')
  },
  {
    name: "my-account",
    path: "/my-account",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./my-account-DZympxoO.mjs')
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import('./_id_-DfX5M8UF.mjs')
  },
  {
    name: "products",
    path: "/products",
  ...
  },
  {
    ...
    component: () => import('./Profile-B26F7kcW.mjs')
  },
  {
    name: "wishlist",
    path: "/wishlist",
    component: () => import('./index-aZvp5Gc5.mjs')
  }
];
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-DVJ7N2Bq.mjs')),
  default: defineAsyncComponent(() => import('./default-vRRu3CKd.mjs')),
  landing: defineAsyncComponent(() => import('./landing-DzVH_Vjz.mjs')),
