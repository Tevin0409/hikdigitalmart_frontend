...
import { _ as __nuxt_component_0, s as script$F } from './index-DMVaXLtj.mjs';
import { useSSRContext, resolveComponent, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createElementBlock, createElementVNode, normalizeClass, normalizeStyle, renderSlot, toHandlers, createBlock, resolveDynamicComponent, createCommentVNode, resolveDirective, withDirectives, createSlots, Fragment, renderList, normalizeProps, withModifiers, Transition, withKeys, ref, computed } from 'vue';
...
import { s as script$7$2, a as script$y, O as OverlayEventBus, g as getVNodeProp, U as UniqueComponentId, _ as _default, C as ConnectedOverlayScrollHandler, b as script$2$5 } from './index-BxMozEdj.mjs';
import { s as script$x, a as script$1$5 } from './index-BjfqnR8d.mjs';
import { s as script$B, a as script$2$4, b as script$3$2 } from './index-CI0zemKa.mjs';
import { B as BaseDirective, R as Ripple } from './index-5ckDHAkT.mjs';
import { a as script$C, s as script$1$7 } from './index-BewzCk0X.mjs';
import { s as script$D } from './index-BgtDrjLh.mjs';
import { a as script$1$6, b as script$E, s as script$2$3 } from './index-ZzPV6IeI.mjs';
import { s as script$z } from './index-DcyyOm7X.mjs';
import { s as script$A } from './index-W-Mshwtv.mjs';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Carousel = script$F;
...
const _sfc_main = {
  name: "ProductSection",
  components: { CardsHome: __nuxt_component_1, TopDeal, NewArrivals, Footer: __nuxt_component_0 },
  data() {
    return {
      price: "Ksh 2,400.00",
      images: [
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "product-section pt-20 px-4 md:px-16" }, _attrs))} data-v-ed831a8b><div class="flex flex-wrap justify-center items-start" data-v-ed831a8b><div class="product-details w-full md:w-1/3 mb-6 md:mb-0" data-v-ed831a8b><div class="badge text-primary text-sm font-semibold mb-2" data-v-ed831a8b> 100% Best Product </div><h1 class="text-3xl md:text-4xl font-bold mb-4" data-v-ed831a8b>HD Bullet Camera</h1><p class="text-gray-500 text-base md:text-lg mb-6" data-v-ed831a8b>Wide Angle</p><div class="price flex items-center text-xl md:text-2xl font-semibold text-red-600 mb-4" data-v-ed831a8b>${ssrInterpolate($data.price)} <span class="line-through text-gray-400 text-lg ml-4" data-v-ed831a8b>Ksh 2,860</span></div><div class="discount flex items-center mb-6" data-v-ed831a8b><div class="flex items-center text-lg text-primary mr-4" data-v-ed831a8b><span class="text-xl font-bold" data-v-ed831a8b>29%</span> off </div></div><div class="stock flex items-center text-sm text-gray-600 mb-6" data-v-ed831a8b><div class="w-full max-w-xs" data-v-ed831a8b><div class="relative" data-v-ed831a8b><div class="h-2 bg-gray-300 rounded" data-v-ed831a8b><div class="h-2 bg-primary rounded w-2/3" data-v-ed831a8b></div></div></div><div class="flex justify-between text-xs mt-2" data-v-ed831a8b><span data-v-ed831a8b>Available: 334</span><span data-v-ed831a8b>Stock: 180</span></div></div></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="px-6 py-3 bg-primary text-white rounded-lg shadow-lg hover:bg-secondary" data-v-ed831a8b${_scopeId}> SHOP NOW \u2192 </button>`);
      } else {
        return [
          createVNode("button", { class: "px-6 py-3 bg-primary text-white rounded-lg shadow-lg hover:bg-secondary" }, " SHOP NOW \u2192 ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</div><div class="dynamic-image flex justify-center items-center w-full md:w-1/3 mb-6 md:mb-0" data-v-ed831a8b><img${ssrRenderAttr("src", $data.selectedImage)} alt="Selected Product" class="w-full max-w-xs rounded-md border-0" data-v-ed831a8b><div class="absolute bottom-0 left-0 text-white bg-primary text-sm px-3 py-1 rounded-full transform -translate-x-1/2 translate-y-1/2" data-v-ed831a8b> 29% off </div></div><div class="hidden md:block w-full md:w-1/3 pa-6 ma-5 pl-40 dark:border-orange-600" data-v-ed831a8b><div class="border border-red-600 dark:border-orange-600 rounded p-4" data-v-ed831a8b><div class="mb-4 border-b pb-2 font-medium text-dark-600 text-center" data-v-ed831a8b> Top Product </div>`);
  _push(ssrRenderComponent(_component_Carousel, {
    d_circular: true,
    autoplayInterval: 3e3,
    value: $data.products,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        _push2(`<div class="text-center" data-v-ed831a8b${_scopeId}><img${ssrRenderAttr("src", (_a = slotProps.data) == null ? void 0 : _a.image)}${ssrRenderAttr("alt", (_b = slotProps.data) == null ? void 0 : _b.name)} class="object-cover rounded max-w-full mx-auto" data-v-ed831a8b${_scopeId}><div class="mt-4 font-medium" data-v-ed831a8b${_scopeId}>${ssrInterpolate((_c = slotProps.data) == null ? void 0 : _c.name)}</div><div class="font-semibold text-xl py-2" data-v-ed831a8b${_scopeId}>${ssrInterpolate(slotProps.data.price)}</div><div class="stock flex items-center text-sm text-gray-600 mb-4" data-v-ed831a8b${_scopeId}><span data-v-ed831a8b${_scopeId}>Available: 334</span> | <span data-v-ed831a8b${_scopeId}>Stock: 180</span></div></div>`);
      } else {
        return [
  ...
  _push(`</div></div></div><div class="carousel flex justify-center items-center mt-8 space-x-4" data-v-ed831a8b><button class="text-gray-600 hover:text-gray-800 px-3 py-2 bg-gray-100 rounded-full shadow-md" data-v-ed831a8b> \u2190 </button><div class="flex items-center space-x-2 overflow-x-auto" data-v-ed831a8b><!--[-->`);
  ssrRenderList($data.images, (image, index) => {
    _push(`<img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", "Product " + (index + 1))} class="${ssrRenderClass([{ "border-orange-500": $data.selectedImage === image }, "w-12 h-12 md:w-16 md:h-16 rounded-md border border-gray-300 cursor-pointer hover:border-orange-500"])}" data-v-ed831a8b>`);
  });
  _push(`<!--]--></div><button class="text-gray-600 hover:text-gray-800 px-3 py-2 bg-gray-100 rounded-full shadow-md" data-v-ed831a8b> \u2192 </button></div><div class="feature__wrap grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 mt-12" data-v-ed831a8b><!--[-->`);
  ssrRenderList($data.features, (feature, index) => {
    _push(`<div class="feature__item flex flex-col items-center text-center" data-v-ed831a8b><div class="icon text-4xl text-red-500" data-v-ed831a8b><i class="${ssrRenderClass(feature.icon)}" data-v-ed831a8b></i></div><div class="content mt-2" data-v-ed831a8b><h3 class="text-lg font-semibold" data-v-ed831a8b>${ssrInterpolate(feature.title)}</h3><p class="text-sm text-gray-600" data-v-ed831a8b>${ssrInterpolate(feature.description)}</p></div></div>`);
  });
  _push(`<!--]--></div>`);
  ...
  _push(ssrRenderComponent(_component_Footer, { class: "w-full bg-gray-100 text-gray-800 py-10" }, null, _parent));
  _push(`</div>`);
}
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-ed831a8b"]]);

export { Dashboard as default };
//# sourceMappingURL=Home-C3bWLVrs.mjs.map
