...
import { s as script } from './index-DJ-ZgwLv.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($setup.wishList.length < 1) {
    ...
    ssrRenderList($setup.wishList, (item, index2) => {
      ...
      _push(`<button class="absolute top-2 right-2 rounded-full p-1 hover:text-red-500"><i class="pi pi-trash text-red-700" style="${ssrRenderStyle({ "font-size": "1.4rem" })}"></i></button></div><div class="p-4"><h3 class="text-md font-semibold truncate">${ssrInterpolate((_e = item.productModel) == null ? void 0 : _e.name)} <br><span class="text-sm font-light">${ssrInterpolate((_f = item.productModel) == null ? void 0 : _f.name)}</span></h3><p class="text-gray-500 mb-2"><span class="text-red-500 font-bold"><i class="pi pi-wallet"></i> Ksh ${ssrInterpolate($setup.formattedPrice((_g = item.productModel) == null ? void 0 : _g.price))}</span>`);
...
//# sourceMappingURL=index-UhnId7iG.mjs.map
