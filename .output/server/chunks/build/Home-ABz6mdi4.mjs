...
import { s as script$7$2, a as script$y, O as OverlayEventBus, g as getVNodeProp, U as UniqueComponentId, _ as _default, C as ConnectedOverlayScrollHandler, b as script$2$4 } from './index-BXa5O8IC.mjs';
import { s as script$x, a as script$1$4 } from './index-BjfqnR8d.mjs';
import { s as script$B, a as script$2$3, b as script$3$2 } from './index-CI0zemKa.mjs';
...
import { a as script$1$5, b as script$E, s as script$2$2 } from './index-ZzPV6IeI.mjs';
...
import { T as TopDeal, s as script$H } from './TopDeal-kRUo3V2L.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-99d74241><div class="flex flex-wrap justify-center items-start" data-v-99d74241><div class="product-details w-full md:w-1/3 mb-6 md:mb-0" data-v-99d74241><div class="badge text-primary text-sm font-semibold mb-2" data-v-99d74241> 100% Best Product </div><h1 class="text-3xl md:text-4xl font-bold mb-4" data-v-99d74241>HD Bullet Camera</h1><p class="text-gray-500 text-base md:text-lg mb-6" data-v-99d74241>Wide Angle</p><div class="price flex items-center text-xl md:text-2xl font-semibold text-red-600 mb-4" data-v-99d74241>${ssrInterpolate($data.price)} <span class="line-through text-gray-400 text-lg ml-4" data-v-99d74241>Ksh 2,860</span></div><div class="stock flex items-center text-sm text-gray-600 mb-6" data-v-99d74241><div class="w-full max-w-xs" data-v-99d74241><div class="relative" data-v-99d74241><div class="h-2 bg-gray-300 rounded" data-v-99d74241><div class="h-2 bg-primary rounded w-2/3" data-v-99d74241></div></div></div><div class="flex justify-between text-xs mt-2" data-v-99d74241><span data-v-99d74241>Available: 334</span><span data-v-99d74241>Stock: 180</span></div></div></div>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/dashboard" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="px-6 py-3 bg-primary text-white rounded-lg shadow-lg hover:bg-secondary" data-v-99d74241${_scopeId}> SHOP NOW <i class="pi pi-angle-right" data-v-99d74241${_scopeId}></i></button>`);
      } else {
        return [
  ...
  _push(`</div><div class="dynamic-image flex justify-center items-center w-full md:w-1/3 mb-6 md:mb-0" data-v-99d74241><img${ssrRenderAttr("src", $data.selectedImage)} alt="Selected Product" class="w-full max-w-xs rounded-md border-0" data-v-99d74241></div><div class="hidden md:block bg-whit w-full md:w-1/3 pa-6 ma-5 pl-40 dark:border-orange-600" data-v-99d74241><div class="border border-red-600 dark:border-orange-600 rounded p-4" data-v-99d74241><div class="mb-4 border-b pb-2 font-medium text-dark-600 text-center" data-v-99d74241> Top Product </div>`);
  _push(ssrRenderComponent(_component_Carousel, {
    d_circular: true,
    autoplayInterval: 3e3,
    value: $data.products,
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        _push2(`<div class="text-center" data-v-99d74241${_scopeId}><img${ssrRenderAttr("src", (_a = slotProps.data) == null ? void 0 : _a.image)}${ssrRenderAttr("alt", (_b = slotProps.data) == null ? void 0 : _b.name)} class="object-cover rounded max-w-full mx-auto" data-v-99d74241${_scopeId}><div class="mt-4 font-medium" data-v-99d74241${_scopeId}>${ssrInterpolate((_c = slotProps.data) == null ? void 0 : _c.name)}</div><div class="font-semibold text-xl py-2" data-v-99d74241${_scopeId}>${ssrInterpolate(slotProps.data.price)}</div><div class="stock flex items-center text-sm text-gray-600 mb-4" data-v-99d74241${_scopeId}></div></div>`);
      } else {
        return [
  ...
  _push(`</div></div></div><div class="carousel flex justify-center items-center mt-8 space-x-4" data-v-99d74241><button class="text-gray-600 hover:text-gray-800 px-3 py-2 bg-gray-100 rounded-full shadow-md" data-v-99d74241> \u2190 </button><div class="flex items-center space-x-2 overflow-x-auto" data-v-99d74241><!--[-->`);
  ssrRenderList($data.images, (image, index) => {
    _push(`<img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", "Product " + (index + 1))} class="${ssrRenderClass([{ "border-orange-500": $data.selectedImage === image }, "w-12 h-12 md:w-16 md:h-16 rounded-md border border-gray-300 cursor-pointer hover:border-orange-500"])}" data-v-99d74241>`);
  });
  _push(`<!--]--></div><button class="text-gray-600 hover:text-gray-800 px-3 py-2 bg-gray-100 rounded-full shadow-md" data-v-99d74241> \u2192 </button></div><div class="feature__wrap grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 mt-12" data-v-99d74241><!--[-->`);
  ssrRenderList($data.features, (feature, index) => {
    _push(`<div class="feature__item flex bg-white flex-col items-center text-center" data-v-99d74241><div class="icon text-4xl text-red-500" data-v-99d74241><i class="${ssrRenderClass(feature.icon)}" data-v-99d74241></i></div><div class="content mt-2" data-v-99d74241><h3 class="text-lg font-semibold" data-v-99d74241>${ssrInterpolate(feature.title)}</h3><p class="text-sm text-gray-600" data-v-99d74241>${ssrInterpolate(feature.description)}</p></div></div>`);
  });
  _push(`<!--]--></div>`);
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-99d74241"]]);

export { Dashboard as default };
//# sourceMappingURL=Home-ABz6mdi4.mjs.map
