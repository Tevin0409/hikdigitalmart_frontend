  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (cartItems.value.length < 1) {
        ...
        _push(`<!--]--></div><div class="col-span-12 md:col-span-3"><div class="cart-total rounded-lg"><h3 class="text-lg font-semibold">Cart Total</h3><p class="text-gray-600"> Subtotal: Ksh ${ssrInterpolate(formattedPrice(cartTotal.value))}</p><hr class="my-2"><p class="text-lg font-bold"> Total: Ksh ${ssrInterpolate(formattedPrice(cartTotal.value))}</p><button class="w-full bg-primary text-white py-2 mt-4 rounded-lg hover:bg-secondary"> Checkout (${ssrInterpolate(formattedPrice(cartTotal.value))}) </button></div></div></div></div></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=index-BGAX_xre.mjs.map
