...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="flex w-full align-center justify-center" style="${ssrRenderStyle({ "background-image": "url('https://www.sdl.co.ke/assets/images/icons/vector-1.png')" })}" data-v-8ab29baf><div class="flex w-full h-screen flex-col items-center justify-center" data-v-8ab29baf><div class="flex justify-center items-center absolute top-16 left-8" data-v-8ab29baf><a href="/dashboard" class="text-primary text-md cursor-pointer hover:text-secondary" data-v-8ab29baf><i class="pi pi-arrow-left text-primary pr-2 hover:text-secondary" style="${ssrRenderStyle({})}" data-v-8ab29baf></i> Back to Shop</a></div><div class="border shadow-lg p-8 rounded-xl bg-white text-center flex flex-col items-center" data-v-8ab29baf><img${ssrRenderAttr("src", _imports_0)} alt="Login" class="h-28 w-28 mb-6 mx-auto" data-v-8ab29baf><p class="text-gray-500 text-2xl mb-10" data-v-8ab29baf> Enter your details below to sign up </p>`);
  if (!$data.otpSent) {
    _push(`<form class="w-full flex flex-col items-center" data-v-8ab29baf><div class="flex space-x-4 mb-4 w-full" data-v-8ab29baf>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="firstName" data-v-8ab29baf${_scopeId}>First Name</label>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="lastName" data-v-8ab29baf${_scopeId}>Last Name</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "text",
    ...
    _push(`</div><div class="flex flex-col space-y-4 mb-4 w-full" data-v-8ab29baf>`);
    _push(ssrRenderComponent(_component_FloatLabel, {
      variant: "on",
      class: "w-full"
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="email" data-v-8ab29baf${_scopeId}>Email</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "email",
    ...
    _push(ssrRenderComponent(_component_FloatLabel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(`<label for="phoneNumber" data-v-8ab29baf${_scopeId}>Mobile Phone</label>`);
        } else {
          return [
            createVNode(_component_InputText, {
              type: "number",
    ...
    _push(`</div><button type="submit" class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600 mt-6" data-v-8ab29baf> Sign Up </button></form>`);
  } else {
    _push(`<div class="flex flex-col items-center text-center w-full" data-v-8ab29baf><h3 class="text-3xl font-medium mb-4" data-v-8ab29baf>Verify OTP</h3><p class="text-gray-500 mb-6" data-v-8ab29baf> Enter the OTP sent to your email address. <span class="font-weight-bold font-bold" data-v-8ab29baf>${ssrInterpolate($data.form.email)}</span></p><div class="w-full flex justify-center mb-4" data-v-8ab29baf><div class="flex justify-center w-full" data-v-8ab29baf>`);
    ...
    _push(`</div></div><button class="w-full bg-red-500 text-white py-3 rounded hover:bg-red-600" data-v-8ab29baf> Verify OTP </button></div>`);
  }
  _push(`<p class="text-sm mt-4" data-v-8ab29baf> Already have an account? <span class="text-blue-500 cursor-pointer" data-v-8ab29baf> Log in </span></p></div></div><div class="hidden md:block h-full w-full p-4 relative" data-v-8ab29baf>`);
  _push(ssrRenderComponent(_component_Carousel, {
    ...
    item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="relative w-full h-screen flex justify-center items-center" data-v-8ab29baf${_scopeId}><img${ssrRenderAttr("src", slotProps.data.src)}${ssrRenderAttr("alt", slotProps.data.alt)} class="rounded-xl object-cover w-100 h-100" data-v-8ab29baf${_scopeId}><div class="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-50 text-white py-2 px-4 rounded" data-v-8ab29baf${_scopeId}>${ssrInterpolate(slotProps.data.alt)}</div></div>`);
      } else {
        return [
...
const SignupForm = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-8ab29baf"]]);
var script$b = {
  name: "EyeIcon",
  "extends": script$l
};
...
const LoginForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-f915195d"]]);
...
const QuestionnaireForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8c652570"]]);
...
//# sourceMappingURL=index-CsJusGmE.mjs.map
