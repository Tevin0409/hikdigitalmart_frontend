import{_ as qe}from"./DqC5WPmK.js";import{R as he}from"./DJUQs7ia.js";import{b as fe,a as Ze,s as Je}from"./xLu0QVGG.js";import{B as le,q as R,o as l,c as u,s as I,b as y,v as s,aH as Qe,a1 as Ke,a as c,N as me,G as P,u as j,H as J,I as m,t as A,a4 as F,K as te,L as ce,A as Ae,E as Te,D as ne,p as Ee,w as v,T as De,F as $,m as ae,d as ie,W as oe,ab as Z,as as Xe,C as Ye,ah as _e,aI as Ie,Z as et,a2 as tt,J as we,x as ke,r as B,R as N,Q as nt,y as G,S as it}from"./tL2_9plP.js";import{U as se,C as Ve,O as Fe,s as ot,b as at,a as st}from"./DezqP0JS.js";import{Z as W,s as Pe}from"./CuWZ3smw.js";import{s as be}from"./CsQfmC0I.js";import{s as lt}from"./BQSjnp9Y.js";import{s as rt}from"./SwgnqYOB.js";import{s as ct}from"./BSnAQvLL.js";import{_ as Le}from"./DfOKB53i.js";var ut=function(e){var n=e.dt;return`
.p-overlaybadge {
    position: relative;
}
...
`)},dt={root:"p-overlaybadge"},pt=le.extend({name:"overlaybadge",theme:ut,classes:dt}),ht={name:"OverlayBadge",extends:fe,style:pt,provide:function(){return{$pcOverlayBadge:this,$parentInstance:this}}},ze={name:"OverlayBadge",extends:ht,inheritAttrs:!1,components:{Badge:fe}};function ft(t,e,n,o,a,i){var f=R("Badge");return l(),u("div",s({class:t.cx("root")},t.ptmi("root")),[I(t.$slots,"default"),y(f,s(t.$props,{pt:t.ptm("pcBadge")}),null,16,["pt"])],16)}ze.render=ft;var mt=function(e){var n=e.dt;return`
.p-menu {
...
`)},Tt={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},Et=le.extend({name:"chip",theme:At,classes:Tt}),Dt={name:"BaseChip",extends:be,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:Et,provide:function(){return{$pcChip:this,$parentInstance:this}}},$e={name:"Chip",extends:Dt,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},components:{TimesCircleIcon:rt}},Vt=["aria-label"],Ft=["src"];function Pt(t,e,n,o,a,i){return a.visible?(l(),u("div",s({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root")),[I(t.$slots,"default",{},function(){return[t.image?(l(),u("img",s({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,Ft)):t.$slots.icon?(l(),P(J(t.$slots.icon),s({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(l(),u("span",s({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):m("",!0),t.label?(l(),u("div",s({key:3,class:t.cx("label")},t.ptm("label")),A(t.label),17)):m("",!0)]}),t.removable?I(t.$slots,"removeicon",{key:0,removeCallback:i.close,keydownCallback:i.onKeydown},function(){return[(l(),P(J(t.removeIcon?"span":"TimesCircleIcon"),s({class:[t.cx("removeIcon"),t.removeIcon],onClick:i.close,onKeydown:i.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):m("",!0)],16,Vt)):m("",!0)}$e.render=Pt;var zt=function(e){var n=e.dt;return`
.p-autocomplete {
    display: inline-flex;
}
